...
test('list should be generated correctly', () => {
  ...
  expect(jsonParser(elements)).toEqual(`<ul><li>List Item</li><li>Second Item</li></ul>`)
})
...
test('attributes should be added to the html elmement', () => {
  ...
  expect(jsonParser(elements)).toEqual(`<div data-translation-id="46" data-div-name="MyFirst Div"><header><script src="example.js"></script></header></div>`)
})
...
test('text of parent element should be inserted before child nodes', () => {
  ...
  expect(jsonParser(elements)).toEqual(`<section>test section<p>Lorem Ipsum</p></section>`)
})
